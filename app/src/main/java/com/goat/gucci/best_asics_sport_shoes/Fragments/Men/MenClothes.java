package com.goat.gucci.best_asics_sport_shoes.Fragments.Men;
 ...
 */
public class MenClothes extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_men_clothes, container, false);

        context = getContext();

        setUpRecyclerAdapter();

        recycler = (RecyclerView) view.findViewById(R.id.men_clothes);
    ...
    private void setUpRecyclerAdapter() {
        ...
        reference = FirebaseDatabase.getInstance().getReference("Men").child("Clothes");
        ...
        adapter = new FirebaseRecyclerAdapter<BasicModel, SmallViewHolder>(options) {
            ...
            public SmallViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                ...
                return new SmallViewHolder(context,view,"Men");
            }
        };
