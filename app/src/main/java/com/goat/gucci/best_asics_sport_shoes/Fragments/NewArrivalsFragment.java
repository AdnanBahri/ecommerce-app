...
public class NewArrivalsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recycler = (RecyclerView) view.findViewById(R.id.new_arrivals);
    ...
    private void setUpRecyclerAdapter() {
        ...
        reference = FirebaseDatabase.getInstance().getReference("New Arrivals");
        ...
        adapter = new FirebaseRecyclerAdapter<BasicModel, SmallViewHolder>(options) {
            ...
            public SmallViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                ...
                return new SmallViewHolder(context,view,"New Arrivals");
            }
        };
