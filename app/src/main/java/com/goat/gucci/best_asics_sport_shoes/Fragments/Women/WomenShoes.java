 ...
 */
public class WomenShoes extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recycler = (RecyclerView) view.findViewById(R.id.women_shoes);
    ...
    private void setUpRecyclerAdapter() {
        ...
        reference = FirebaseDatabase.getInstance().getReference("Women").child("Shoes");
