package com.goat.gucci.best_asics_sport_shoes.Fragments.Kids;
 ...
 */
public class KidsShoes extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_kids_shoes, container, false);

        context = getContext();

        setUpRecyclerAdapter();

        recycler = (RecyclerView) view.findViewById(R.id.kids_shoes);
    ...
    private void setUpRecyclerAdapter() {
        ...
        reference = FirebaseDatabase.getInstance().getReference("Kids").child("Shoes");
        ...
        adapter = new FirebaseRecyclerAdapter<BasicModel, SmallViewHolder>(options) {
            ...
            public SmallViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                ...
                return new SmallViewHolder(context,view,"Kids");
            }
        };
