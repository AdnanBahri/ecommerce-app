 ...
 */
public class MenAccessories extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recycler = (RecyclerView) view.findViewById(R.id.men_accessories);
    ...
    private void setUpRecyclerAdapter() {
        ...
        reference = FirebaseDatabase.getInstance().getReference("Men").child("Accessories");
